...
#cd outputs/
#medType="med1"
mkdir $Pythia_{medType}_${jobNumber}_numEvents${nEvents}/
cd $Pythia_{medType}_${jobNumber}_numEvents${nEvents}/
...
cmsRun ../../GeneratorInterface/JewelInterface/test/testPythiaZ2Star.py output="${low}_${high}_Pythia_$jobNumber" maxEvents=$nEvents ptHatLow=$low ptHatHigh=$high &> Pythia_${jobNumber}_numEvents${nEvents}.log
