...
do
    ...
    bsub -R "pool>300000" -M 300000 -q 1nh -J job_${jobNum} < /afs/cern.ch/work/j/jcoulter/WORK/CMSSW_5_3_20/src/SummerRutgers15/Bash_Scripts/Batch_Scripts/PythiaSubmit.sh
    let "i++"
    let "jobNum++"
done
